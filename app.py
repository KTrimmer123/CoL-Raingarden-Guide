...
# --- CALCULATOR PAGE ---
st.markdown("""
<div style='text-align:center; font-family:Poppins, sans-serif; font-size:2.2rem; font-weight:600; margin-top:1rem; margin-bottom:1rem; color:#30322F;'>
    City of London Raingarden Calculator
</div>
<hr style='border: none; height: 2px; background-color: #17E0A7; margin-bottom: 1.5rem;'>
""", unsafe_allow_html=True)

with st.expander("📥 Input Parameters", expanded=True):
    area = st.number_input("Raingarden Area (m²)", min_value=1, value=10)
    catchment = st.number_input("Catchment Area (m²)", min_value=1, value=100)
    void_options = {
    ...
    depth = int(st.number_input("Attenuation Depth (mm)", min_value=0, value=300, step=5))
...
# (rest of calculator logic and results — unchanged from previous)

# Let me know if you want me to paste the rest as well, or move on to Step 3: reset button.
